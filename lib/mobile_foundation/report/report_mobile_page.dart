...
class ReportMobilePage extends StatefulWidget {
  ...
  @override
  State<ReportMobilePage> createState() =>
      _ReportMobilePageState();
}
...
class _ReportMobilePageState extends State<ReportMobilePage> {
  ...
  final List<_ReportMenuItem> _reportMenus = const [
    _ReportMenuItem(
      title: 'Laporan Harian',
      subtitle: 'Lihat dan export laporan barang harian',
      icon: Icons.inventory_2_outlined,
      color: Color(0xff64b5f6),
    ),
    _ReportMenuItem(
      title: 'Laporan Mingguan',
      subtitle: 'Pantau stok dan laporan barang mingguan',
      icon: Icons.bar_chart_rounded,
      color: Color(0xff43d17b),
    ),
    _ReportMenuItem(
      title: 'Laporan Bulanan',
      subtitle: 'Lihat seluruh riwayat transaksi pada bulan ini',
  ...
  List<_ReportMenuItem> _filteredMenus() {
    ...
    return _reportMenus.where((item) {
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 6),
                        Text(
                          'Pantau dan kelola laporan operasional',
                          style: TextStyle(
                ...
                children: [
                  Expanded(
                    child: _buildInfoChip(
                      ...
                      label: '${_reportMenus.length} Modul',
                    ),
                  ),
  ...
  void _openMenu(_ReportMenuItem item) {
...
class _ReportGlassCard extends StatefulWidget {
  final _ReportMenuItem item;
  final VoidCallback onTap;

  const _ReportGlassCard({
    required this.item,
    required this.onTap,
  });

  @override
  State<_ReportGlassCard> createState() =>
      _ReportGlassCardState();
}

class _ReportGlassCardState extends State<_ReportGlassCard> {
  bool _pressed = false;
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: widget.item.color.withOpacity(0.24),
                          ),
                          boxShadow: [
                            BoxShadow(
                              color: widget.item.color.withOpacity(0.13),
                              blurRadius: 18,
                            ),
                          ],
                        ),
